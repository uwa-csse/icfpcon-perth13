...
probs = [ p for p in probs if p['size'] > 11 and  p['size'] <= 12 and ((not 'solved' in p) or not p['solved']) and 'tfold' in p['operators'] and not 'and' in p['operators'] and 'plus' in p['operators'] and 'if0' in p['operators'] ]
